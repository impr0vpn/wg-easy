...
module.exports.WG_DEFAULT_ADDRESS = process.env.WG_DEFAULT_ADDRESS || '10.7.x.x';
...
iptables -t nat -A POSTROUTING -s ${module.exports.WG_DEFAULT_ADDRESS.replace('x.x', '0.0')}/16 -o ${module.exports.WG_DEVICE} -j MASQUERADE;
...
iptables -t nat -D POSTROUTING -s ${module.exports.WG_DEFAULT_ADDRESS.replace('x.x', '0.0')}/16 -o ${module.exports.WG_DEVICE} -j MASQUERADE;
